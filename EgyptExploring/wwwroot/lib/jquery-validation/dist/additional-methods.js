...
$.validator.addMethod( "bankaccountNL", function( value, element ) {
	...
	if ( !( /^[0-9]{9}|([0-9]{2} ){3}[0-9]{3}$/.test( value ) ) ) {
		...
		var account = value.replace( / /g, "" ), 		sum = 0,
		len = account.length,
		pos, factor, digit;
 ...
 * Further rules can be found in Spanish on http: *
...
$.validator.addMethod( "cifES", function( value, element ) {
	...
	var letter  = value.substring( 0, 1 ), 		number  = value.substring( 1, 8 ), 		control = value.substring( 8, 9 ), 		all_sum = 0,
		even_sum = 0,
		odd_sum = 0,
		i, n,
		control_digit,
 ...
 * Redistributed under the Apache License 2.0 at http: * Valid Types: mastercard, visa, amex, dinersclub, enroute, discover, jcb, unknown, all (overrides all other settings)
 */
 ...
 *
 * Poland National Numbering Plan http: */
